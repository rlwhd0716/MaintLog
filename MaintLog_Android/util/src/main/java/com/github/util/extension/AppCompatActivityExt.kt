...
inline fun <reified T : Activity> AppCompatActivity.startActivityIntent(noinline block: (Intent.() -> Unit)? = null, noinline action: (() -> Unit)? = null) {
...
fun AppCompatActivity.getAppVersion(): String {
    ...
    try {
        ...
        version = manager.getPackageInfo(this.packageName, 0).versionName ?: "0.0.0"
